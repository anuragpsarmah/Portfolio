...
function HeroSection() {
  const options = {
    strings: [
      ...
      "skills: ['React', 'NextJS', 'Express', 'Recoil', 'Redux', 'MongoDB', 'MySql', 'Docker', 'AWS'],",
      "techWorm: true,",
      "problemSolver: true,",
      "documentationReader: true,",
      "hireable: function() {",
      "return (",
      "this.problemSolver &&",
      "this.documentationReader &&",
  ...
  return (
    <section className="relative flex flex-col items-center justify-between py-4 lg:py-12">
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        ...
        <div className="order-1 lg:order-2 from-[#0d1224] border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r to-[#0a0d37] lg:h-[30rem] h-[29.5rem] w-[20rem] lg:w-[34rem] md:w-[35rem]">
